			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Tenant Rented and Payment List</b>
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$res_tenant = mysqli_fetch_assoc($tenant);
								$sql = mysqli_query($conn, "SELECT * FROM payment where tenant_id = '" . $res_tenant['id'] . "'");
								...
								?>
										<tr>
											...
											<td class="text-center">
												...
												<?php } ?>
												<a href="paymentProof/<?php echo $row['proof'] ?>" download="" class="btn btn-outline-success">Download Proof</a>
											</td>
										</tr>
									<?php }
								} else { ?>
