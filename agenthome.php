                    ...
                    <div class="row">
                            ...
                            <div class="card border-primary">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM houses WHERE landlord_id = ".$_SESSION['login_id'])->num_rows ?>
                                        </b></h4>
                                        <p><b>Total Properties</b></p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM tenantss where landlord_id = ".$_SESSION['login_id'])->num_rows ?>
                                        </b></h4>
